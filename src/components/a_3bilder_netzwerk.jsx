...
const cards = [
  ...
  return (
    <section className='pt-8'>
      <div>
        <span className="max-w-6xl mx-auto px-4 md:px-8 grid grid-cols-1 md:grid-cols-3 gap-5 m-8 z-10 relative">
          // SO PROFITIERT IHR VOM NETZWERK.
        </span>
      </div>        
      <div className="max-w-6xl mx-auto px-4 md:px-8 grid grid-cols-1 md:grid-cols-3 gap-5 m-8 z-10 relative">
