              ...
              <div className="relative w-full flex gap-2">
                <div className="relative flex-1">
                  ...
                  <input
                    ...
                    required
                    className="w-full bg-slate-900 border border-slate-800 rounded-xl pl-9 pr-4 py-2 text-white focus:outline-none focus:border-cyan-400 font-mono text-xs h-9 tracking-wide"
                  />
                </div>
                
                <button
                  type="submit"
                  className="bg-gradient-to-r from-cyan-500 to-purple-500 text-slate-950 font-mono font-black px-4 h-9 rounded-xl text-[10px] uppercase tracking-wider shadow-lg hover:scale-[1.02] active:scale-[0.98] transition-all cursor-pointer shrink-0 flex items-center justify-center"
                >
                  Gigs Scannen 📡
                </button>
              </div>
