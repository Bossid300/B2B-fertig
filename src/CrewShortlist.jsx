...
const [showMatrixInfo, setShowMatrixInfo] =
  useState(false);
            ...
            <>
              <button
                ...
                onClick={() => {
                  ...
                  if (typeof onNavigateToStep === 'function') {
                    onNavigateToStep('artists');
                  }
                }}
                className="px-4 py-2 rounded-xl border border-purple-500/30 bg-purple-950/20 text-purple-400 text-xs font-mono uppercase font-black tracking-wider hover:border-purple-400 transition-all"
              >
                🔮 MATRIX SEARCH
              ...
              {showMatrixInfo && (
                <div className="absolute inset-0 z-50 bg-slate-950/90 backdrop-blur-sm flex items-center justify-center">
                  <div className="w-full max-w-md rounded-3xl border border-purple-500/30 bg-slate-950 p-6">
                    <div className="text-purple-400 font-black mb-4 text-lg">
                      🔮 MATRIX SEARCH
                    </div>
                    ...
                    <button
                      ...
                      className="w-full py-3 rounded-xl bg-cyan-500 text-slate-950 font-bold uppercase tracking-wider"
                    >
                      OK
                    </button>
                  </div>
