          ...
          <div className="space-y-6 animate-fade-in font-mono">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-stretch">
              ...
              <div className="bg-slate-900/20 border border-slate-900 rounded-2xl p-5 flex flex-col justify-between">
                ...
                {/* Der Editier-Button sitzt perfekt in der rechten Spalte unten */}
                <div className="pt-4 flex justify-end">
                  <button 
                    onClick={() => setIsEditing(true)}
                    className="w-full bg-slate-900 border border-slate-800 hover:border-slate-700 text-slate-300 text-[9px] font-bold uppercase py-1.5 rounded-xl transition-all cursor-pointer text-center tracking-wider"
                  >
                    ⚙️ SPECIFICATIONS EDITIEREN
                  </button>
                </div>
              </div>
