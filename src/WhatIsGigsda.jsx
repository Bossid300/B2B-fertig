...
export default function WhatIsGigsda() {
  return (
    <div className="max-w-4xl mx-auto my-8 p-6 space-y-8 text-slate-100 font-sans antialiased select-none animate-fade-in">
      ...
      <div className="space-y-4">
        <div className="space-y-0.5">
          ...
          <span className="text-[8px] text-slate-600 font-mono uppercase block tracking-wider">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs">
          ...
          <div className="bg-slate-950/40 border border-slate-900 rounded-2xl p-4 space-y-2 hover:border-slate-800 transition-colors">
            <div className="flex items-center gap-2 text-white font-bold tracking-tight">
              <Layers className="w-4 h-4 text-cyan-400" /> 1. Digitaler Rider
            </div>
          ...
          <div className="bg-slate-950/40 border border-slate-900 rounded-2xl p-4 space-y-2 hover:border-slate-800 transition-colors">
            <div className="flex items-center gap-2 text-white font-bold tracking-tight">
              <Eye className="w-4 h-4 text-emerald-400" /> 2. Realtime-Radar
            </div>
            <p className="text-slate-500 text-[11px] font-sans leading-relaxed">
          ...
          <div className="bg-slate-950/40 border border-purple-500/20 rounded-2xl p-4 space-y-2 hover:border-purple-500/30 transition-colors">
            <div className="flex items-center gap-2 text-white font-bold tracking-tight">
              <CheckCircle2 className="w-4 h-4 text-purple-400" /> 3. Der Zusage-Deal
            </div>
            <p className="text-slate-500 text-[11px] font-sans leading-relaxed">
      ...
      <div className="bg-slate-950/60 border border-slate-900 rounded-3xl p-5 space-y-4 shadow-2xl relative overflow-hidden">
        ...
        <div className="space-y-1">
          <span className="text-[8px] text-purple-400 font-mono uppercase block">// FOKUS: 3. DER ZUSAGE-DEAL</span>
          <p className="text-slate-400 text-xs leading-relaxed font-sans max-w-2xl">
        ...
        <div className="flex justify-between items-center border-t border-slate-900/60 pt-3 text-[10px]">
          <span className="text-slate-600 font-mono">Möchtest du dieses Tool live in deinem eigenen Dashboard nutzen?</span>
      ...
      <div className="space-y-4 pt-2">
        <div className="text-right">
          <span className="text-[8px] bg-cyan-500/10 border border-cyan-400/20 text-cyan-400 font-mono uppercase tracking-widest px-2 py-0.5 rounded">
            Aktionsebene
          </span>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-[11px]">
          ...
          <div className="space-y-4 bg-slate-950/20 border border-slate-900 p-5 rounded-3xl">
            <div className="space-y-1">
              <h4 className="text-xs font-black text-white uppercase tracking-tight flex items-center gap-2">
                <Eye className="w-4 h-4 text-cyan-400" /> 1. Unangemeldete Besucher (Gäste)
              </h4>
              <span className="text-[8px] text-slate-600 font-mono uppercase block">// DIE REINE INFORMATIONSEBENE</span>
            </div>
            ...
            <ul className="space-y-2 text-slate-400 font-sans">
              <li className="flex items-start gap-2">
                <span className="text-cyan-400">➔</span> <span><strong className="text-slate-300">Öffentliche Portfolios einsehen:</strong> Betrachte verifizierte Acts, Bands und Musiker-Präsenzen (wie op-winston.html).</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-cyan-400">➔</span> <span><strong className="text-slate-300">Regionaler Event-Kalender:</strong> Sieh ein, welche Gigs, Open-Airs und Hallen-Konzerte in deiner Umgebung geplant sind.</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-cyan-400">➔</span> <span><strong className="text-slate-300">Infrastruktur prüfen:</strong> Überzeuge dich im Sucher von der Dichte an Technikern und Verleihern in deiner PLZ-Region.</span>
              </li>
            </ul>
          </div>
          ...
          <div className="space-y-4 bg-slate-950/20 border border-slate-900 p-5 rounded-3xl">
            <div className="space-y-1">
              <h4 className="text-xs font-black text-white uppercase tracking-tight flex items-center gap-2">
                <Award className="w-4 h-4 text-amber-400" /> 2. Registrierte Mitglieder (Acts, Clubs, Crew)
              </h4>
              <span className="text-[8px] text-slate-600 font-mono uppercase block">// DAS VOLLAKTIVE KONTROLLZENTRUM</span>
            </div>
            <p className="text-slate-500 font-sans leading-relaxed">
